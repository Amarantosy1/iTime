...
public struct OpenAICompatibleAIConversationService: AIConversationServing, Sendable {
    ...
    提问时注意：
    - 紧扣用户提供的时间数据、任务进展或当前话题，引导用户深入反思自己的精力分配
    ...
    把这次对话里你真正获取到的关于时间消耗、精力和任务执行相关的线索整理出来，像朋友之间真实的反馈：有你自己的观察和判断，有具体依据，有关于时间安排的实际建议——不走模板，不说空话，不聊无关琐事。

    写法：
    - headline：一句话，明确指出用户在这段时间里时间或任务管理上最核心的特征或矛盾
    - summary：2-4 句，像你对朋友说"我觉得你这段时间的时间分配……"，核心是对精力与任务的判断
    ...
    你是用户的一位博学老朋友，帮他/她写一篇关于时间消耗与任务安排的系统复盘。
    写一篇聚焦于时间管理和任务执行情况的深度反思文章。这要体现你对他/她时间分配、精力规律和行动力的诊断评估，切忌闲聊或偏离时间主题。
    不要直接改写聊天记录，而是抽象出关于效率、计划完成和精力管理的深层思考。
    ...
    "具体行动建议"至少 3 条，每条关于时间或任务管理的内容说清楚：做什么、什么情况下做、怎么起步、怎么衡量改善效果。
    语言：中文、有温度、客观具体地讨论时间账单与精力话题。
